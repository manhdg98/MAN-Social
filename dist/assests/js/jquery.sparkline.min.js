        ...
        for (i = 0; i < yvalcount; i++) {
          ...
          if (y === null) {
            ...
            vertex = [
              xpos,
              canvasTop +
                Math.round(canvasHeight - canvasHeight * ((y - this.miny) / rangey))
            ];
            path.push(vertex);
            ...
            if (color) {
              target
                .drawCircle(
                  ...
                  canvasTop +
                    Math.round(
                      canvasHeight - canvasHeight * ((yvalues[i] - this.miny) / rangey)
                    ),
                  spotRadius,
                  undefined,
                  color
          ...
          if (spotRadius && options.get("minSpotColor")) {
            ...
            target
              .drawCircle(
                ...
                canvasTop +
                  Math.round(
                    canvasHeight - canvasHeight * ((this.minyorg - this.miny) / rangey)
                  ),
                spotRadius,
                undefined,
                options.get("minSpotColor")
          ...
          if (spotRadius && options.get("maxSpotColor")) {
            ...
            target
              .drawCircle(
                ...
                canvasTop +
                  Math.round(
                    canvasHeight - canvasHeight * ((this.maxyorg - this.miny) / rangey)
                  ),
                spotRadius,
                undefined,
                options.get("maxSpotColor")
