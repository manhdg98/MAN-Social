...
(function () {
  ...
  "GENERATED_CDN_VSN" !== u.Ob &&
    (v.options.flash.swf = u.xc + "vjs.zencdn.net/" + u.Ob + "/video-js.swf");
  u.La = {};
  u.ka = u.CoreObject = m();
  ...
  u.d = function (a, c, d) {
    ...
    1 == e.z[c].length &&
      (document.addEventListener
        ? a.addEventListener(c, e.S, l)
        : document.attachEvent && a.attachEvent("on" + c, e.S));
  };
  u.t = function (a, c, d) {
    if (u.kc(a)) {
      var e = u.getData(a);
  ...
  u.cc = function (a, c) {
    ...
    0 === d.z[c].length &&
      ...
      document.removeEventListener
        ? a.removeEventListener(c, d.S, l)
        : document.detachEvent && a.detachEvent("on" + c, d.S));
  ...
  u.i.ec = function (a, c) {
    ...
    for (d in c)
      w.call(c, d) &&
        ((e = a[d]), (g = c[d]), (a[d] = u.i.mc(e) && u.i.mc(g) ? u.i.ec(e, g) : c[d]));
    return a;
  };
  u.i.copy = function (a) {
    return u.i.B({}, a);
  ...
  t.X = function (a, c) {
    ...
    "string" === typeof a
      ? ((e = a),
        (c = c || {}),
        (d = c.componentClass || u.Y(e)),
        (c.name = e),
        (d = new window.videojs[d](this.a || this, c)))
      : (d = a);
    this.D.push(d);
  ...
  t.removeChild = function (a) {
    ...
    if (a && this.D) {
      ...
      c &&
        ...
        (this.R[a.name] = h),
        (c = a.r()) &&
          c.parentNode === (this.pa || this.b) &&
          (this.pa || this.b).removeChild(a.r()));
    }
  };
  t.P = r("");
  t.d = function (a, c) {
  ...
  function C(a, c) {
    ...
    if (a.f.md)
      return (
        ...
        d && ((d = d.r().offsetHeight), (j += d / 2), (g -= d)),
  ...
  u.I.prototype.e = function (a, c) {
    return u.o.prototype.e.call(
      this,
      "li",
      u.i.B({ className: "vjs-menu-item", innerHTML: this.f.label }, c)
    );
  };
  ...
  t.Ea = function () {
    ...
    this.options().title &&
      a
        .r()
        .appendChild(
          u.e("li", { className: "vjs-menu-title", innerHTML: u.Y(this.A), jd: -1 })
        );
  ...
  u.ea = u.c.extend({
    g: function (a, c, d) {
      ...
      this.qc = c.poster;
      this.Da = c.controls;
      c.customControlsOnMobile !== f && (u.Sb || u.Za)
        ? ((a.controls = c.controls), (this.Da = l))
        : (a.controls = l);
    ...
    if (a.hasChildNodes())
      for (var d, e = a.childNodes, g = 0, j = e.length; g < j; g++)
        (a = e[g]),
          ...
          "source" === d
            ? c.sources.push(u.vb(a))
            : "track" === d && c.tracks.push(u.vb(a));
    return c;
  }
  t.e = function () {
    ...
    if (c.hasChildNodes())
      for (var d = c.childNodes.length, e = 0, g = c.childNodes; e < d; e++)
        ("source" == g[0].nodeName.toLowerCase() ||
          "track" == g[0].nodeName.toLowerCase()) &&
          c.removeChild(g[0]);
  ...
  function F(a, c, d) {
    a.h
      ? ((a.Z = l),
        a.h.C(),
        a.Cb && ((a.Cb = l), clearInterval(a.Na)),
        a.Db && G(a),
        (a.h = l))
      : "Html5" !== c && a.N && (a.b.removeChild(a.N), (a.N.oc = h), (a.N = h));
    a.ua = c;
    a.Z = l;
    var e = u.i.B({ source: d, parentEl: a.b }, a.f[c.toLowerCase()]);
    d &&
      (d.src == a.s.src && 0 < a.s.currentTime && (e.startTime = a.s.currentTime),
      (a.s.src = d.src));
    ...
    a.h.M(function () {
      ...
      if (!this.j.Kb) {
        ...
        a.Na = setInterval(
          u.bind(a, function () {
            this.s.lb < this.buffered().end(0)
              ? this.k("progress")
              : 1 == H(this) && (clearInterval(this.Na), this.k("progress"));
          }),
          500
        );
  ...
  t.currentTime = function (a) {
    return a !== b
      ? ((this.s.vd = a),
        J(this, "setCurrentTime", a),
        this.Db && this.k("timeupdate"),
        this)
      : (this.s.currentTime = I(this, "currentTime") || 0);
  };
  ...
  t.Pa = function () {
    ...
    a
      ? (u.d(
        ...
        this.b[a.sc]())
      : this.h.Qa()
      ? J(this, "enterFullScreen")
      : ((this.Qc = f),
        (this.Lc = document.documentElement.style.overflow),
        u.d(document, "keydown", u.bind(this, this.gc)),
  ...
  t.src = function (a) {
    if (a instanceof Array) {
      ...
      c
        ? ((a = c.source), (c = c.h), c == this.ua ? this.src(a) : F(this, c, a))
        : this.b.appendChild(
            u.e("p", {
              innerHTML:
      ...
      a instanceof Object
        ? window.videojs[this.ua].canPlaySource(a)
          ? this.src(a.src)
          : this.src([a])
        : ((this.s.src = a),
          this.Z
            ? (J(this, "src", a),
              "auto" == this.f.preload && this.load(),
              this.f.autoplay && this.play())
            : this.M(function () {
                this.src(a);
              }));
    return this;
  ...
  t.Ma = function (a) {
    return a !== b
      ? (J(this, "setPreload", a), (this.f.preload = a), this)
      : I(this, "preload");
  };
  t.autoplay = function (a) {
    return a !== b
      ? (J(this, "setAutoplay", a), (this.f.autoplay = a), this)
      : I(this, "autoplay");
  };
  t.loop = function (a) {
  ...
  N = {};
  O.rd !== b
    ? ((N.sc = "requestFullscreen"),
      (N.nb = "exitFullscreen"),
      (N.tb = "fullscreenchange"),
      (N.F = "fullScreen"))
    : (document.mozCancelFullScreen
        ? ((M = "moz"), (N.F = M + "FullScreen"))
        : ((M = "webkit"), (N.F = M + "IsFullScreen")),
      O[M + "RequestFullScreen"] &&
        ((N.sc = M + "RequestFullScreen"), (N.nb = M + "CancelFullScreen")),
      (N.tb = M + "fullscreenchange"));
  ...
  u.ba = u.c.extend({
    g: function (a, c) {
      ...
      a.Q(
        ...
        u.bind(this, function () {
          var a,
            c = u.bind(this, this.ha),
            g = u.bind(this, this.Fa);
          this.ha();
          "ontouchstart" in window ||
            (this.a.d("mouseover", c),
            this.a.d("mouseout", g),
            this.a.d("pause", u.bind(this, this.nc)),
            this.a.d("play", u.bind(this, this.Sa)));
          a = l;
          ...
          this.a.d(
            ...
            u.bind(this, function (c) {
              var e;
              a &&
                ((e = this.r().className.search("fade-in")),
                -1 !== e ? this.Fa() : this.ha());
              a = l;
  ...
  u.Wa.prototype.xa = function () {
    ...
    this.content.innerHTML =
      '<span class="vjs-control-text">Current Time </span>' + u.Ga(a, this.a.duration());
  };
  u.Xa = u.c.extend({
    g: function (a, c) {
      u.c.call(this, a, c);
  ...
  u.Xa.prototype.xa = function () {
    this.a.duration() &&
      (this.content.innerHTML =
        '<span class="vjs-control-text">Duration Time </span>' + u.Ga(this.a.duration()));
  };
  u.Zb = u.c.extend({
    g: function (a, c) {
      u.c.call(this, a, c);
  ...
  u.eb.prototype.xa = function () {
    this.a.duration() &&
      ...
      (this.content.innerHTML =
        ...
        u.Ga(this.a.duration() - this.a.currentTime()));
  };
  u.za = u.o.extend({
    g: function (a, c) {
      u.o.call(this, a, c);
  ...
  u.za.prototype.n = function () {
    this.a.F
      ? (K(this.a), (this.b.children[0].children[0].innerHTML = "Fullscreen"))
      : (this.a.Pa(), (this.b.children[0].children[0].innerHTML = "Non-Fullscreen"));
  };
  u.cb = u.c.extend({
    g: function (a, c) {
      u.c.call(this, a, c);
  ...
  u.da.prototype.update = function () {
    ...
    this.a.muted()
      ? "Unmute" != this.b.children[0].children[0].innerHTML &&
        (this.b.children[0].children[0].innerHTML = "Unmute")
      : "Mute" != this.b.children[0].children[0].innerHTML &&
        (this.b.children[0].children[0].innerHTML = "Mute");
  ...
  u.Ba.prototype.Ea = function () {
    var a = new u.la(this.a, { Ic: "div" }),
      c = new u.hb(this.a, u.i.B({ md: f }, this.f.zd));
    a.X(c);
    return a;
  };
  ...
  function da() {
    ...
    return function () {
      throw Error(
        'The "' + a + "\" method is not available on the playback technology's API"
      );
    };
  }
  ...
  u.m = u.q.extend({
    g: function (a, c, d) {
      ...
      this.j.hc = f;
      u.q.call(this, a, c, d);
      (c = c.source) && this.b.currentSrc == c.src
        ? a.k("loadstart")
        : c && (this.b.src = c.src);
      a.M(function () {
  ...
  t.e = function () {
    ...
    if (!c || this.j.Sc === l)
      c
        ? (a.r().removeChild(c), (c = c.cloneNode(l)))
  ...
  t.Qa = function () {
    return "function" == typeof this.b.webkitEnterFullScreen &&
      (/Android/.test(u.O) || !/Chrome|Mac OS X 10.5/.test(u.O))
      ? f
      : l;
  };
  t.src = function (a) {
  ...
  u.l = u.q.extend({
    g: function (a, c, d) {
      ...
      d = c.source;
      var e = c.parentEl,
        g = (this.b = u.e("div", { id: a.id() + "_temp_flash" })),
        j = a.id() + "_flash_api";
      a = a.f;
      var k = u.i.B(
          {
        ...
        q = u.i.B({ wmode: "opaque", bgcolor: "#000000" }, c.params),
        n = u.i.B({ id: j, name: j, class: "vjs-tech" }, c.attributes);
  ...
  function W(a) {
    0 === a.ja && a.load();
    0 === a.ia &&
      (a.a.d("timeupdate", u.bind(a, a.update, a.L)),
      a.a.d("ended", u.bind(a, a.reset, a.L)),
      ("captions" === a.A || "subtitles" === a.A) && a.a.R.textTrackDisplay.X(a));
  }
  t.load = function () {
    0 === this.ja &&
      ((this.ja = 1), u.get(this.tc, u.bind(this, this.Zc), u.bind(this, this.Eb)));
  };
  t.Eb = function (a) {
    this.error = a;
    this.ja = 3;
      ...
      if (this.Jb === b || a < this.Jb || this.Ha <= a) {
        ...
        for (;;) {
          ...
          if (n.ra <= a) (e = Math.max(e, n.ra)), n.Ca && (n.Ca = l);
            ...
            g
              ? (j.splice(0, 0, n), q === b && (q = s), (k = s))
              : (j.push(n), k === b && (k = s), (q = s)),
              (d = Math.min(d, n.ra)),
  ...
  u.V.prototype.qb = function () {
    ...
    for (var d = 0; d < U(this.a).length; d++)
      (c = U(this.a)[d]), c.H() === this.A && a.push(new u.W(this.a, { track: c }));
    return a;
  };
  u.ya = u.V.extend({
    g: function (a, c, d) {
  ...
  t.Ea = function () {
    ...
    if (g) {
      ...
      for (var k, c = 0, d = e.length; c < d; c++)
        (k = e[c]), (k = new u.Va(this.a, { track: g, cue: k })), j.push(k), a.X(k);
    }
