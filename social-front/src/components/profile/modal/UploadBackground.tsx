...
const UploadAvatar = (props) => {
  ...
  return (
    <Modal title="Upload Background" visible={props.isModalVisible} onOk={handleOk} onCancel={props.handleCancel}>
      <div className="d-flex align-items-center w-100">
        { 
          imgData ? 
          <Image width={200} height={100} id="background" src={imgData}/> 
          :
