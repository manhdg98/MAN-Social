        ...
        <div className="col-lg-3">
            <aside className="sidebar static">
                <div className="widget">
                    ...
                    <ul className="naves">
                        <li className={`${childTabActive === ContentTabImage.AVATAR ? "active" : ''}`}
                            onClick={() =>  changeTabActive(ContentTabImage.AVATAR)}
                        >
                            <i className="fa fa-user-circle" />
                            <a> Avatar </a>
                        </li>
                        <li className={`${childTabActive === ContentTabImage.BACKGROUND ? "active" : ''}`}
                            onClick={() =>  changeTabActive(ContentTabImage.BACKGROUND)}
                        >
                            <i className="fa fa-picture-o" />
                            <a> Background </a>
                        </li>
                        <li className={`${childTabActive === ContentTabImage.TIMELINE ? "active" : ''}`}
