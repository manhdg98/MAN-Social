    ...
    <div className="user-profile">
        <figure>
            ...
            <div className="wrapper-background">
                { data.profileReducer.imgBackground ? <Image id="background" src={data.profileReducer.imgBackground}/> : <Skeleton /> }
            </div>
        ...
        <div className="profile-section">
            <div className="row">
                <div className="col-lg-2 col-md-3">
                    ...
                    {(data.reducer.info != undefined && data.profileReducer.imgAvatar) ? ( <>
                        <div className="profile-author-thumb">
                            <div className="rounded-circle border border-light" style={{overflow: 'hidden'}}>
                                <Image id="background" src={data.profileReducer.imgAvatar} style={{objectFit: 'cover'}}/> 
                            </div>
                            <div className="edit-dp">
                                <Button type="primary" onClick={showModalUpdateAvatar} className="hidden-btn-antd">
                        ...
                        <div className="author-content">
                            <a className="h4 author-name">{data.reducer.info.username}</a>
                            <div className="country">{data.reducer.info.email}</div>
                        </div>
