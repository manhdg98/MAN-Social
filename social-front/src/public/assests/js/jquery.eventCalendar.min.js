!(function (a) {
  a.fn.jalendar = function (e) {
    function t() {
      ...
      e.setFullYear(D, M, 0);
      var t = e.getDay() + C;
      v.find(".header h1").html(o[l.lang][M] + " " + D + '<div class="total-bar"></div>'),
        v
          .find(".day")
          .html("&nbsp;")
        ...
        l.dayWithZero === !0 && (r = r < 10 ? "0" + r : r),
          ...
          "linker" == l.type
            ? v
                ...
                .addClass("this-month")
                .attr("data-date", i)
                .html('<span><a href="' + l.customUrl + i + '">' + r + "</a></span>")
            : v
                .find(".day")
                .eq(t - 1)
                .addClass("this-month")
      ...
      M == w.getMonth() && D == w.getFullYear()
        ? v
            ...
            .eq(k - 1)
            .addClass("today")
        : v.find(".day.this-month").removeClass("today").attr("style", ""),
      ...
      v.find('.day[data-date="' + I.val() + '"]').addClass("first-range"),
        ...
        v.find('.day[data-date="' + P.val() + '"]').length > 0 &&
          (v.find(".day.first-range").length > 0
            ? v.find(".day.first-range").nextUntil(".day.last-range").addClass("range")
            : v.find(".day.last-range").prevUntil(".day:eq(0)").addClass("range"));
    }
    var l = a.extend(
        {
          customDay: new Date(),
    ...
    v.append(
      a('<input type="hidden" class="data1" /><input type="hidden" class="data2" />'),
      ...
      v.on("click", ".this-month:not(.disable-selecting)", function () {
        function e(a) {
          a
            ...
            (E = v
              .find('[data-date="' + v.find(".first-range").attr("data-date") + '"]')
              .index()),
            (j = Number(v.find(".days").attr("data-month"))),
            (z = Number(v.find(".days").attr("data-year"))),
            (F = null),
        ...
        if ("selector" == l.type)
          return (
            ...
            v.parent().is(".jalendar-input") &&
              (v.parent().find("input").removeClass("selected"),
              v.parent(".jalendar-input").find("input").val(a(this).data("date"))),
              ...
              t(a(this)),
                ...
                v.parent().is(".jalendar-input") &&
                  ...
                  v
                    ...
                    .find("input")
                    .val(
                      v.find("input.data1").val() + ", " + v.find("input.data2").val()
                    )),
                null !== l.done && l.done.call(this);
            }
          else e(a(this));
        ...
        v.find(".events .event-single").remove(),
          ...
          "" === l.type &&
            (v.find("input.data1").val(a(this).data("date")),
            a(this).addClass("selected"),
            v.find(".add-event").find(".events-list").html(n.clone()),
            v.parent().is(".jalendar-input") &&
              v.parent(".jalendar-input").find("input").val(a(this).data("date")),
            v.find(".events .event-single").length >= 0 &&
              v.find(".events h3 span").html(v.find(".events .event-single").size()),
            v
              .find(".add-event")
              .addClass("selected")
