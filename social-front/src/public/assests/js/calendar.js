...
(function (t, e) {
  ...
  function r(n, r, c) {
    ...
    function F(t) {
      p() &&
        (ie.setEventData(pe), ie.renderEvents(pe, t), ie.trigger("eventAfterAllRender"));
    }
    function N() {
  ...
  function o(n, r) {
    ...
    function w(t) {
      ...
      (t._id = t._id || (t.id === e ? "_fc" + xe++ : t.id + "")),
        ...
        t.className
          ? "string" == typeof t.className && (t.className = t.className.split(/\s+/))
          : (t.className = []);
    }
    function b(t) {
      t.className
  ...
  function E(n, r, a) {
    n.unbind("mouseover").mouseover(function (n) {
      ...
      (i = o._fci) !== e &&
        ((o._fci = e), (s = r[i]), a(s.event, s.element, s), t(n.target).trigger(n)),
        n.stopPropagation();
    });
  }
  function S(e, n, r) {
  ...
  function Z(e, n, r) {
    ...
    function u() {
      ...
      for (
        r += "<thead><tr>",
          ue && (r += "<th class='fc-week-number " + n + "'>" + q(de) + "</th>"),
          t = 0;
        ne > t;
        t++
      )
    ...
    function g(e) {
      ...
      "variable" == he("weekMode")
        ...
        J.each(function (e, o) {
          ee > e &&
            ((a = t(o)), a.find("> div").css("min-height", (e == ee - 1 ? r : n) - R(a)));
        });
    }
    function p(t) {
      ($ = t),
    ...
    Y(e.addClass("fc-grid")),
      (ae = new ye(function (e, n) {
        ...
        P.each(function (e, i) {
          ...
          I.each(function (n, i) {
            ee > n &&
              ((r = t(i)), (a = r.offset().top), n && (o[1] = a), (o = [a]), (e[n] = o));
          }),
          (o[1] = a + r.outerHeight());
      })),
      (oe = new we(ae)),
  ...
  function K(n, r, a) {
    ...
    function s() {
      ...
      for (
        c(),
          ce = t("<div style='position:absolute;z-index:2;left:0;width:100%'/>").appendTo(
            n
          ),
          Ue("allDaySlot")
            ? ((ue = t(
          ...
          ge = t("<div style='position:relative;width:100%;overflow:hidden'/>").appendTo(
            he
          ),
          be = t(
            "<div class='fc-event-container' style='position:absolute;z-index:8;top:0;left:0'/>"
      ...
      for (
        a += "<thead><tr>",
          Xe
            ? ((t = nn(0, 0)),
              ...
              Ye ? (e += Je) : (e = Je + e),
              (a +=
                "<th class='fc-agenda-axis fc-week-number " + r + "'>" + q(e) + "</th>"))
        ...
        (t = nn(0, n)),
          (a +=
            ...
            "</th>");
      return (a +=
        "<th class='fc-agenda-gutter " + r + "'>&nbsp;</th>" + "</tr>" + "</thead>");
    }
    function p() {
      var t,
        e,
        ...
        l = "";
      for (
        l += "<tbody><tr><th class='fc-agenda-axis " + o + "'>&nbsp;</th>", n = "", e = 0;
        We > e;
        e++
      )
        (t = nn(0, e)),
    ...
    function _(t, n) {
      ...
      var r = Ue("slotMinutes"),
        ...
        i = sn[o];
      return (
        i === e && (i = sn[o] = Ce.find("tr").eq(o).find("td div")[0].offsetTop),
    ...
    Y(n.addClass("fc-agenda")),
      (Oe = new ye(function (e, n) {
        ...
        for (
          var s = ge.offset().top, l = he.offset().top, c = l + he.outerHeight(), u = 0;
          Ae * Ne > u;
          u++
        )
  ...
  function te() {
    ...
    function a(e) {
      ...
      for (r = 0; c > r; r++)
        for (
          n = P(0, r), u(n, f), l = o(e, h, n, u(d(n), v - f)), l = ee(l), a = 0;
          l.length > a;
          a++
        )
      ...
      e.resizable({
        ...
        resize: function (s, l) {
          (r = Math.round((Math.max(o, e.height()) - l.originalSize.height) / o)),
            r != a &&
              (n.text(ae(t.start, r || t.end ? u(M(t), i * r) : null, y("timeFormat"))),
              (a = r));
        },
        stop: function (n, a) {
  ...
  function oe(t, n, r) {
    ...
    if (t.forwardCoord === e)
      for (
        o.length
          ? (o.sort(ce), oe(o[0], n + 1, r), (t.forwardCoord = o[0].backwardCoord))
          : (t.forwardCoord = 1),
  ...
  function fe(n, r, a) {
    ...
    function y(t, n) {
      n.click(function (r) {
        return n.hasClass("ui-draggable-dragging") || n.hasClass("ui-resizable-resizing")
          ? e
  ...
  function me() {
    function e(e, n) {
      ...
      return (
        r ||
          (r = t("<div class='fc-cell-overlay' style='position:absolute;z-index:3'/>")),
  ...
  function we(e) {
    function n(t) {
      ...
      (!n != !i || (n && (n.row != i.row || n.col != i.col))) &&
        (n ? (o || (o = n), a(n, o, n.row - o.row, n.col - o.col)) : a(n, o), (i = n));
    }
    var r,
      a,
      o,
