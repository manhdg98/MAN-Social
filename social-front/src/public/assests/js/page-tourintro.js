...
!(function (t, e) {
    ...
    if (
      ...
      (n._onKeyDown = function (e) {
        if (27 === e.keyCode && 1 == n._options.exitOnEsc)
          l.call(n, t), void 0 != n._introExitCallback && n._introExitCallback.call(n);
  ...
  function l(t) {
    ...
    if (null != e) {
      ...
      window.removeEventListener
        ...
        : document.detachEvent && document.detachEvent("onkeydown", this._onKeyDown),
  ...
  function a(t, e, n, o) {
    ...
    if (
      ...
      (currentTooltipPosition = this._introItems[this._currentStep].position),
        ("auto" == currentTooltipPosition || "auto" == this._options.tooltipPosition) &&
  ...
  function d(t) {
    ...
    if (
      ...
      if (
        ((n.className = i), (y.style.opacity = 0), (y.style.display = "none"), null != c)
      ) {
        var j = this._introItems[t.step - 2 >= 0 ? t.step - 2 : 0];
        ((null != j && "forward" == this._direction && "floating" == j.position) ||
      ...
      for (
        var H = document.createElement("ul"), N = 0, O = this._introItems.length;
        O > N;
        N++
      ) {
    ...
    return (
      ...
      (e.onclick = function () {
        1 == o._options.exitOnOverlayClick &&
          (l.call(o, t), void 0 != o._introExitCallback && o._introExitCallback.call(o));
      }),
      setTimeout(function () {
    ...
    (C.fn = e.prototype =
      {
        ...
        refresh: function () {
          return (
            ...
            p.call(this, document.querySelector(".introjs-tooltipReferenceLayer")),
            this
          );
        },
